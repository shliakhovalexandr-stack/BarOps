...
// Стажер теж отримує повний вигляд: саме опис приготування він і має вивчати,
// картка з коротким складом для навчання марна.
function isFullView() {
  return ['bartender', 'cook', 'chef', 'admin', 'trainee'].includes(roleLc());
}
