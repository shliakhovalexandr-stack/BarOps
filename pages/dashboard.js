...
const QUICK_PAY_AUDIT = { route:'pay-audit', badge:null, label:'Типи оплат', hint:'Рахунки з товаром «Бар ТОВ» на чужому типі оплати', color:'var(--red-bg)', iconColor:'var(--red)',
  svg:`<rect x="2" y="4" width="14" height="10" rx="1.6" stroke="currentColor" stroke-width="1.3" fill="none"/>
...
const QUICK_INVOICE_OCR = { route:'invoice-ocr', badge:null, label:'Накладні', hint:'Фото накладної → прихід у POS', color:'var(--purple-bg)', iconColor:'var(--purple)',
...
const QUICK_DISASSEMBLY = { route:'disassembly', badge:null, label:'Розбір', hint:'1 товар → частини: списання + прихід', color:'var(--amber-bg)', iconColor:'var(--amber)',
  svg:`<path d="M10 3v5M10 8l-4.5 6M10 8l4.5 6" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/>
       <circle cx="10" cy="3.5" r="1.6" stroke="currentColor" stroke-width="1.2"/>
       <circle cx="5" cy="15.5" r="1.6" stroke="currentColor" stroke-width="1.2"/>
       <circle cx="15" cy="15.5" r="1.6" stroke="currentColor" stroke-width="1.2"/>` };
...
// ABC-аналіз страв (виторг/прибуток/к-сть). Зона Бар/Кухня за роллю: шеф→кухня, керуючий/сисменеджер→обидві.
const QUICK_ABC = { route:'abc', badge:null, label:'ABC-аналіз', hint:'Що приносить основний виторг', color:'var(--teal-bg)', iconColor:'var(--teal)',
  svg:`<path d="M3 3v14h14" stroke="currentColor" stroke-width="1.3" stroke-linecap="round"/>
       <rect x="6" y="9" width="2.6" height="5" rx="0.6" fill="currentColor"/>
       <rect x="10" y="6" width="2.6" height="8" rx="0.6" fill="currentColor"/>
       <rect x="14" y="11" width="2.6" height="3" rx="0.6" fill="currentColor"/>` };
...
const CHEF_ROUTES = ['performance', 'playlist', 'price-alert', 'abc', 'journal', 'stop-list', 'schedule', 'ordering', 'ocr', 'stock', 'writeoff', 'production', 'disassembly', 'inventory'];
