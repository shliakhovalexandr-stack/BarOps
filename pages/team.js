...
const TEAM_GROUPS = [
  ...
  { label: 'Хозяюшки',    roles: ['cleaner', 'housekeeper'] },
  { label: 'Хостес / Babysitter', roles: ['hostess', 'babysitter'] },
